...
{
    /**
     * @Route("/liste-categorie", name="categorie_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/ajouter-categorie", name="categorie_new", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/categorie/{id}/modifier", name="categorie_edit", methods={"GET", "POST"})
     */
